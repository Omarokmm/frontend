...
const Cases = () => {
      ...
      .then((res) => {
        ...
        axios
          ...
          .then((res) => {
            ...
            // console.log(
            //   "getClinicsWithActiveCases222222",
            //   getClinicsWithActiveCases3(resultClinics, packingCasesbuff,result)
            // );
          })
          .catch((error) => {});
      })
  ...
  const getClinicsWithActiveCases = (clinics, cases, allCases) => {
    console.log("Clinics:", clinics, "Cases:", cases, "All Cases:", allCases);
